    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.airpollut"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.airpollut.tests.tests"

        To run tests in the AirpollutTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.airpollut.tests.tests.AirpollutTestCase"

        To run only the test_if_tethys_platform_is_great function in the AirpollutTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.airpollut.tests.tests.AirpollutTestCase.test_if_tethys_platform_is_great"
...
class AirpollutTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Airpollut)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Airpollut)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/airpollut/')  # The final '/' is essential for all pages/controllers
